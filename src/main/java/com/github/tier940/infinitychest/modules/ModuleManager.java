...
import com.github.tier940.infinitychest.api.modules.*;
...
public class ModuleManager implements IModuleManager {
    ...
    private final Logger logger = LogManager.getLogger("InfinityChest Module Loader");
    ...
    private void configureModules(Map<String, List<IModule>> modules) {
        ...
        config.addCustomCategoryComment(MODULE_CFG_CATEGORY_NAME,
                "Module configuration file. Can individually enable/disable modules from InfinityChest and its addons");
